...
function buttonCounter(mode=0){
  ...
  for(i=0; i<lotState.length;i++){
    ...
    if(i+1==13 ){
      if(lotState[i]){
        document.getElementById("disp1").innerHTML='<br><br><br>1<br>Duration:\n'+h+':'+m;
      }else{
        document.getElementById("disp1").innerHTML='<br><br><br>1<br>Parking available';
      }
    }else if(i+1==14){
      if(lotState[i]){
        document.getElementById(14).innerHTML='<br><br><br>2<br>Duration:\n'+h+':'+m;
      }else{
        document.getElementById(14).innerHTML='<br><br><br>2<br>Parking available';
      }
    }
    }
...
function control_panel(){
  ...
  setDataValues(year,month,day,view_mode,'disabled')
